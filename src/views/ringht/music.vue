<template>
  <div>
    <br>
    <a-card hoverable title="音乐欣赏" :head-style="headStyle">
      <div class="recom-card">
        <a-player :audio="audio" :lrc-type="1" />
      </div>
    </a-card>
  </div>
</template>
    ...
    return {
      ...
      audio: [
        ...
        },
        {
          ...
          cover:
            'https://gss1.bdstatic.com/-vo3dSag_xI4khGkpoWK1HF6hhy/baike/w%3D268%3Bg%3D0/sign=ce3122aecb8065387beaa315afe6c679/d01373f082025aaff92dd92bfaedab64034f1a36.jpg',
          lrc:
        ...
        },
        {
          ...
          name: '无悔一生',
          artist: 'Beyond',
          url: 'http://sc1.111ttt.cn/2015/1/06/02/99021925549.mp3',
          cover:
            'http://p1.music.126.net/n82_qxlHOmfgL9jILf72lg==/87960930223110.jpg?param=130y130',
          lrc:
